...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(arg) {
        var _args = arguments;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                console.log('FROM _APP.JS GETINITIALPROPS:', _args); // console.log('LOG:', arguments.length)
...
//# sourceMappingURL=_app.js.cc3a173fb37ae1da85df.hot-update.js.map